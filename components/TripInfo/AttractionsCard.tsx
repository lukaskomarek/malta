...
const attractions: Attraction[] = [
  ...
  {
    name: 'Wildlife Park Malta',
    desc: 'Tygři, lvi, medvědi, opice, plameniaci — rodinný zážitek v přírodě u Rabatu',
    url: 'https://wildlifemalta.com/',
    kids: true,
    detail: [
      '🕙 Otevřeno: So + svátky 11:00–15:00 · Ne 11:00–16:00 (říjen–červen)',
      '📅 Během pobytu: So 16. 5. (11–15) · Ne 17. 5. (11–16) · So 23. 5. (11–15)',
      '🎟 Dospělí (9+) €15 · Děti 3–9 let €7,50 · Do 3 let zdarma',
      '💶 2 dospělí + 2 děti: €45',
      '🐯 Zvířata: tygři, lvi, leopardi, medvědi, pumas, lynx, opice, plameniaci, jeřábi',
      '📍 Baħrija (u Rabatu) — venkovská oblast, bez přímého autobusu',
      '🚕 Doporučujeme Bolt/taxi z TONN: ~25 min · ~€15–18 jedním směrem',
    ],
  },
